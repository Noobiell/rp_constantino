...
<body>
    ...
    <article class="bannerInicio mb-5">

        <section class="container-fluid h-100">

            <div class="d-flex justify-content-center justify-content-lg-end align-items-center h-100">

                <div class="anuncioBanner">
                    <h1>Tudo que é importante merece proteção</h1>
                    <p>Oferecemos mais segurança para você, sua família e sua empresa!</p>
                </div>
        ...
        <section class="container mb-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <h1 class="tituloPag">Quais os nossos serviços?</h1>
                    <p class="subTextoPag">Veja abaixo os serviços oferecidos em nossa empresa, fique a vontade para contratar o que melhor lhe atender!</p>

                    <ul class="list-group list-group-flush mb-4">

                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Seguro Auto</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Seguro de Moto</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Seguro de Vida</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Plano de Saúde</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Seguro Residencial</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Seguro Empresarial</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Responsabilidade Civil</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Consórcio</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Seguro Rural</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Seguro Viagem</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Equipamentos portáteis</li>
                        <li class="list-group-item"><i class="fa-solid fa-check iconeServicos"></i> Seguro Fiança Locatícia</li>
                ...
                <div class="col-lg-6">
                    <img src="assets/img/mulher_notebook2.jpg" alt="Homem com tablet" class="img-fluid">
                </div>
